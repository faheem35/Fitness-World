...
function getNextSessionTime() {
  ...
  else if (hours >= 10 && hours < 19) return "evening session at 7:00 PM"
  else {
    const tomorrow = new Date()
    tomorrow.setDate(tomorrow.getDate() + 1)
                ...
                {!joined ? (
                  <>
                    {showTimeAlert && (
                      <Alert variant="danger" style={styles.timeAlert}>
                        <i className="fa-solid fa-clock me-2"></i>
                        Sessions are only available during morning (8:00 AM - 10:00 AM) and evening (7:00 PM - 9:00 PM)
                      </Alert>
                    )}
                    ...
                    <div style={styles.sessionInfo}>
                      ...
                      <div style={styles.timeSlots}>
                        <div style={styles.timeSlot}>
                          <i className="fa-solid fa-sun me-1"></i> Morning: 8:00 AM - 10:00 AM
                        </div>
                        <div style={styles.timeSlot}>
                          <i className="fa-solid fa-moon me-1"></i> Evening: 7:00 PM - 9:00 PM
                        </div>
