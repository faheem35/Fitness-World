  ...
  const getAllWorkouts = async () => {
    try {
      ...
      if (result.status === 200) {
        // Filter abs workouts
        const filteredData = result.data.filter(item => item.muscleName.trim() === 'Back');
    ...
    <Header/>
      <div className="muscle-page pt-5">
        <div className="muscle-header">
          <h1>Back Workouts</h1>
          <p>Strengthen your back muscles with these effective exercises</p>
        </div>
