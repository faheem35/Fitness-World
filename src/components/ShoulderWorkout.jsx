...
//                 <h1 className="text-danger text-center py-5">Shoulder Workouts</h1>
    ...
    <Header/>
      <div className="muscle-page pt-5 ">
        <div className="muscle-header ">
          ...
          <p>Sculpt defined shoulders with these targeted exercises</p>
        </div>
        ...
        <Container fluid className="muscle-container">
          {loading ? (
            ...
            <div className="empty-container">
              <p>No Shoulder workouts found</p>
            </div>
          ) : (
