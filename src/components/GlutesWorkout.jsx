  ...
  const getAllWorkouts = async () => {
    try {
      ...
      if (result.status === 200) {
        // Filter abs workouts
        const filteredData = result.data.filter(item => item.muscleName.trim() === 'Glutes');
    ...
    <Header/>
      <div className="muscle-page pt-5">
        <div className="muscle-header">
          ...
          <p>Build strong, sculpted glutes with focused workouts.
</p>
        </div>
