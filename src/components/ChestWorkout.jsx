...
//         const filteredData = result.data.filter(item => item.muscleName.trim() === 'Chest');
...
//         <h1 className="text-danger text-center py-5">Chest Workouts</h1>
    ...
    <Header/>
      <div className="muscle-page pt-5">
        <div className="muscle-header">
          ...
          <p>Develop upper body strength with these chest-focused exercises</p>
        </div>
