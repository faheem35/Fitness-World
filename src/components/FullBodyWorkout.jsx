  ...
  const getAllWorkouts = async () => {
    try {
      ...
      if (result.status === 200) {
        // Filter abs workouts
        const filteredData = result.data.filter(item => item.muscleName.trim() === 'Full Body');
    ...
    <Header/>
      <div className="muscle-page pt-5">
        <div className="muscle-header">
          ...
          <p>Power up your fitness with full body workouts.</p>
        </div>
        ...
        <Container fluid className="muscle-container">
          {loading ? (
            ...
            <div className="empty-container">
              <p>No Full Body workouts found</p>
            </div>
          ) : (
