...
//         <h1 className="text-danger text-center py-5">Abs Workouts</h1>
  
//         {allWorkouts.length > 0 ? (
//           allWorkouts.map(workout => (
//             <div key={workout._id} className="border rounded container bg-white mt-4 ">
//               <Container >
    ...
    <Header/>
      <div className="muscle-page pt-5">
        <div className="muscle-header">
          <h1>Abs Workouts</h1>
          <p>Build your core strength with these effective exercises</p>
        </div>
